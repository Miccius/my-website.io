document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioItems = [
        ...
        {category: 'websites', image: 'Images/Yavin.png', title: 'Yavin Office Space', link: '<a class="link-projects" href="https://yavin-office-space.netlify.app/" target= "_blank" ><p>Visit My Project</p></a>', description: 'Website for a company that creates and customizes office spaces. It could be used for just about any kind of business. It is a very light business theme with a clean design.' },
        {category: 'websites', image: 'Images/Corso.png', title: 'Corso Traning', link: '<a class="link-projects" href="https://corso-website-umber-ten.vercel.app/" target= "_blank" ><p>Visit My Project</p></a>', description: 'Website for training courses, workshops, seminars, etc. It has a mixed design with both light and dark colors and a modern look.' },
        {category: 'websites', image: 'Images/Vera.png', title: 'Vera Sofware', link: '<a class="link-projects" href="https://vera-website-app.netlify.app/" target= "_blank" ><p>Visit My Project</p></a>', description: 'Business website for software solutions, but could easily be changed to fit any business. Dark-themed design with modals and other features.' },
        {category: 'websites', image: 'Images/E-book.png', title: 'E-book Blogs', link: '<a class="link-projects" href="https://e-book-website-psi.vercel.app/" target= "_blank" ><p>Visit My Project</p></a>', description: 'Website for downloading a free E-book. This website has a light, business-oriented design.' },
        {category: 'websites', image: 'Images/Portfolio.png', title: 'Portfolio', link: '<a class="link-projects" href="https://portfolio-website-tmp.netlify.app/" target= "_blank" ><p>Visit My Project</p></a>', description: 'This is a dark-light contrast website for a portfolio. It is related to being a web developer' },
