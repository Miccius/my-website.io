document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioItems = [
        {category: 'wordPress-theme', image: 'Images/fictional university.png', title: 'Fictional-University', link: '<a  class="link-projects" href="http://miccio-uni.rf.gd" target= "_blank"><p>Visit My Projrct</p></a>', description: 'I developed a custom WordPress site using PHP for dynamic fields and a unique theme, showcasing my skills in WordPress development.'},
        {category: 'wordPress-theme', image: 'Images/business site.png', title: 'Business Website', link: '<a  class="link-projects" href="https://github.com/Miccius" target= "_blank">Coming Soon On-line</a>', description: 'I developed a custom WordPress site using PHP for a unique theme, showcasing my skills in WordPress development.'},
