document.addEventListener('DOMContentLoaded', function() {
    ...
    const portfolioItems = [
        ...
        {category: 'wordPress-theme-website', image: 'Images/sito2.png', title: 'Business Website', link: '<a  class="link-projects" href="http://siton2.local/?i=1" target= "_blank">Visit My Project</a>', description: 'I developed a custom WordPress site using PHP for a unique theme, showcasing my skills in WordPress development.'},
